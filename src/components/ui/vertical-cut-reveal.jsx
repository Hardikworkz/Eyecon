  ...
  return (
    <span
      className={cn(
        containerClassName,
        "vertical-cut-reveal",
        splitBy === "lines" && "vertical-cut-reveal--lines"
      )}
      onClick={onClick}
      ref={containerRef}
      {...props}
    >
      <span className="vertical-cut-reveal__sr">{text}</span>
      ...
      {renderedWords.map((wordObj, wordIndex, array) => {
        ...
        return (
          <span
            key={wordIndex}
            aria-hidden="true"
            className={cn("vertical-cut-reveal__word", wordLevelClassName)}
          >
            {wordObj.characters.map((char, charIndex) => (
              <span
                key={charIndex}
                className={cn("vertical-cut-reveal__char-wrap", elementLevelClassName)}
              >
                <motion.span
                  ...
                  className="vertical-cut-reveal__char"
                >
                  {char}
                </motion.span>
              </span>
